...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-100 font-sans px-4">
  <div className="bg-white rounded-lg shadow-2xl overflow-hidden w-full max-w-3xl flex">
